...
export default function CGUPage() {
    ...
    return (
      ...
      <div className="max-w-4xl mx-auto p-6 text-white ">
        <h1 className="text-3xl font-bold text-red-500 mb-4">Conditions Générales d'Utilisation (CGU)</h1>
          ...
          {cgvData.map((item) => (
            ...
            >
              <button
                ...
                className="w-full text-left flex justify-between items-center text-xl font-semibold cursor-pointer hover:text-red-400 transition-colors"
              >
