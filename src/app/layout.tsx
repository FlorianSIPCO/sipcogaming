...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://sipcogaming.fr/'),
  ...
  openGraph: { // Facebook, LinkedIn, Discord
    ...
    url: "https://sipcogaming.fr/", // Confirmer URL
    images: [
      {
        url: "https://sipcogaming.fr/images/logo.jpg", // Image de prévisualisation pour les réseaux sociaux
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "SIPCO Gaming | PC Gamer sur-mesure & Performances optimisées",
    description: "Découvrez nos PC Gamer performants montés sur-mesure avec des composants haut de gamme.",
    images: ["https://sipcogaming.fr/images/logo.jpg"],
  },
  alternates: {
    canonical: "https://sipcogaming.fr/",
    languages: {
      'fr-FR': 'https://sipcogaming.fr'
    }
  },
};
